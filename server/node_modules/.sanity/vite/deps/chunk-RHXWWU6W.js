...
// node_modules/@sanity/vision/lib/_chunks/index-WUX2qElD.js
...
var visionUsEnglishLocaleBundle = defineLocaleResourceBundle({
  ...
  resources: () => import("./resources-bPLLJ09x-7XKBP6WN.js")
});
var visionTool = definePlugin((options) => {
  ...
  return {
    ...
    tools: [{
      ...
      component: (0, import_react.lazy)(() => import("./SanityVision-b2S0ttwz-DSGMIX5B.js")),
      options: config,
      router: route.create("/*")
    }],
    i18n: {
...
//# sourceMappingURL=chunk-RHXWWU6W.js.map
